...
public class ClockProEvictionPreserveYoungerThanTest extends TestingBase {

  protected Cache<Integer, Integer> provideCache(long size, long preserveMillis) {
    return builder(Integer.class, Integer.class).eternal(true).entryCapacity(size).recordModificationTime(true).preserveYoungerThan(preserveMillis).build();
  }
