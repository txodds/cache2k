...
public class Cache2kBuilder<K, V>
  ...
  /**
   * If true, cache eviction will leave non expired entries. default is false
   */
  public final Cache2kBuilder<K, V> preserveNonExpired(boolean f) {
    cfg().setPreserveNonExpired(f);
    return this;
  }
